...
export class DynamicCaddieService implements DynamicCaddieHelper {
  ...
  async generateResponse(
    ...
    try {
      ...
      console.error(`❌ DynamicCaddieService: Error generating response for ${scenario}:`, error);
      ...
      console.warn(`🔄 DynamicCaddieService: Used static fallback for ${scenario}: "${fallbackMessage}"`);
    }
  }
  ...
  private async generateAPIResponse(
    ...
    try {
      console.log('📡 DynamicCaddieService: Generating API + TTS response');
      ...
      console.log(`✅ DynamicCaddieService: API response generated and spoken: "${response.message}"`);
    } catch (error) {
      console.error('❌ DynamicCaddieService: Error in API + TTS response:', error);
