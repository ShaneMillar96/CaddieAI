...
public interface IRoundRepository
{
    ...
    Task<IEnumerable<Round>> GetRoundsByStatusAsync(RoundStatus status);
    ...
    Task<bool> UpdateStatusAsync(int id, RoundStatus status);
    ...
    Task<IEnumerable<Round>> GetPaginatedAsync(int page, int pageSize, int? userId = null, RoundStatus? status = null);
    Task<int> GetTotalCountAsync(int? userId = null, string? status = null);
    Task<int> GetTotalCountAsync(int? userId = null, RoundStatus? status = null);
